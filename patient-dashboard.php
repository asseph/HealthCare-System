...
if($_SESSION['loggedin'] != true)
{
	...
	echo"
	<script>
		alert('Welcome to Patient Panel');
	</script>
	";
}
																...
																echo '<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="#" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="image/'.$image.'" alt="User Image">
																			</a>
																			<a href="#">Dr. '.$drow['name'].' <span>'.$education.'</span></a>
																		</h2>
																	</td>
																	...
																	<td class="text-right">
																		<div class="table-action">
																			<a href="chat.php?id='.$doctorId.'" class="btn btn-sm bg-primary-light">

...
<head>
	...
	<body>
		...
		<div class="main-wrapper">
				...
				<div class="container-fluid">
					<div class="banner-wrapper">
						<div class="banner-header text-center">
							<h1>Doctor, Make an Appointment</h1>
							<p>Discover the best doctors, clinic & hospital the city nearest to you.</p>
                            <p>Meet the doctors by Video call and chat</p>
                            
						</div>
                        <center>
							<a hre="regi">
                        <button type="button" class="btn btn-outline-primary col-lg-4 col-md-6 col-sm-6 mt-6" href="register.php">Get Start</button>
                        </center>
                        <!-- Search -->
		   ...
		   <!-- Availabe Features -->
		   <section class="section section-features" id="feature">
				<div class="container-fluid">
				   <div class="row">

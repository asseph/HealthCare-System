									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="" method="POST" enctype="multipart/form-data">
											<div class="form-group form-focus">
												<input type="text" name="dname" class="form-control floating">
												<label class="focus-label">Name</label>
											</div>
											<div class="form-group form-focus">
												<input type="text" name="mob" class="form-control floating">
											...
											<div class="form-group form-focus">
												<input type="text" name="edu" class="form-control floating">
						 ...
						 if(isset($_POST['submit']))
						  {
							...
							$sql = "INSERT INTO `doctorregistration` (`name`, `email`, `mobile`,`password`) VALUES ('$name', '$email','$mob', '$pwd')";
							$res = mysqli_query($con,$sql);
							$doctor_id = mysqli_insert_id($con);
							if($res)
							{
								$psql = "INSERT INTO `doctorprofile` (`dcotorId`, `education`, `image`) VALUES ('$doctor_id', '$edu', '$filename')";
